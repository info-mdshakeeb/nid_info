...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={` w-80  bg-[#006A4E]  h-screen lg:sticky absolute top-0 overflow-y-auto scrollbar-hide  flex-col  ${isLargeOpen ? "lg:flex" : "lg:hidden"} ${isSmallOpen ? "flex z-[999]" : "hidden"}`} >
